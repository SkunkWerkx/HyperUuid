...
High-performance, allocation-free RFC 9562 UUID generation. One Rust core, direct native FFI into C#, Kotlin, Go, Swift, Ruby, PHP, and Python — no runtime bridge, no reflection. Runs on the server and all the way out to the browser.
...
**Published:** C# ([NuGet](https://github.com/SkunkWerkx/HyperUuid/packages), via GitHub Packages) and Kotlin ([Maven](https://github.com/SkunkWerkx/HyperUuid/packages), via GitHub Packages).
